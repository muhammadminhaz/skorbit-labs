  ...
  return (
    <section id="hero" className="sticky top-0 z-0 min-h-screen flex flex-col items-center justify-center overflow-hidden bg-neutral-950 text-white pt-20">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-blue-500/20 rounded-full blur-[120px]" />
        ...
        <div className="container relative z-10 px-4 flex flex-col items-center text-center gap-8">
            ...
            <motion.h1 
                ...
                className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight max-w-5xl bg-clip-text text-transparent bg-linear-to-b from-white via-white to-white/60"
            >
